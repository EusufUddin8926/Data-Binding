...
public class Product_Provider {
    ...
    private void addProduct(String itemId, String name, String description, double price, double salePrice, float rating, int totalRatings) {
        Product item = new Product(itemId, name, description, price, salePrice, rating, totalRatings, itemId + ".png");
